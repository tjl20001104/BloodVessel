...
class MobileNetV3(nn.Module):
    def __init__(self,
        ...
        layers.append(ConvBNActivation(6,
                                       firstconv_output_c,
                                       kernel_size=3,
                                       stride=2,
                                       norm_layer=norm_layer,
        ...
        self.emb_dim = lastconv_output_c
        self.last_linear = nn.Linear(lastconv_output_c, last_channel)
        self.regression_head = nn.Sequential(nn.Hardswish(inplace=True),
...
def mobilenet_v3_large(num_classes: int = 1000,
                       reduced_tail: int = 1) -> MobileNetV3:

    width_multi = 1.0
    bneck_conf = partial(InvertedResidualConfig, width_multi=width_multi)
    adjust_channels = partial(InvertedResidualConfig.adjust_channels, width_multi=width_multi)
    reduce_divider = reduced_tail
